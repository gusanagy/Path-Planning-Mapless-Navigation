...
class Env():
    ...
    def getOdometry(self, odom):
        ...
        # Precisarei do angulo daqui////criar no self
        ...
        self.goal_ang = round(goal_angle,2)
        self.ang = round(yaw,2)
    ...
    def getState(self, scan):
        ...
        collision = False
        goal = False
        # Maximo 3.5 minimo 0 no scan ranges, no m,eio pode dar valores maiores
        ...
        # se 0.11 para baixo collision true
        if min_range > min(scan_range) > 0:
            collision = True
        # diferenca da posicao com o goal
